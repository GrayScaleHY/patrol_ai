...
sudo docker run -d --gpus '"device=0"' --cpus="8." -e LANG=C.UTF-8 --shm-size 6g --name ut-PatrolAi --restart=always -p 5000:5000 --ipc=host -v /data/PatrolAi:/data/PatrolAi --entrypoint "/data/PatrolAi/patrol_ai/shell/run_PatrolAi.sh" utdnn/patrol_ai:cuda11.4-conda-cuml
```
