...
yolov5_rec_defect = load_yolov5_model("/data/PatrolAi/yolov5/18cls_rec_defect.pt") # 送检18类缺陷,x6模型
...
yolov5_mubiaokuang = load_yolov5_model("/data/PatrolAi/yolov5/cropmodel_A3_20230104.pt")  # 数字表记寻框模型
yolov5_shuzishibie = load_yolov5_model("/data/PatrolAi/yolov5/yolo_without_point_A3_20230105.pt")  # 数字表记数字识别模型
