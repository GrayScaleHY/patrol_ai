...
from lib_sift_match import detect_diff, sift_match, sift_create
...
def identify_defect(img_ref, feat_ref, img_tag, feat_tag):
    ...
    cfgs_tag = inference_yolov5(yolov5_rec_defect_x6, img_tag, resize=1280, conf_thres=0.7, iou_thres=0.2, pre_labels=pre_labels)
    cfgs_ref = inference_yolov5(yolov5_rec_defect_x6, img_ref, resize=1280, conf_thres=0.7, iou_thres=0.2, pre_labels=pre_labels)
