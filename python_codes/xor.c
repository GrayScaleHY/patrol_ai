...
static __Pyx_memviewslice __pyx_f_3xor_xor(__Pyx_memviewslice, __pyx_t_5numpy_uint8_t, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_3xor_xor(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_encode_model_, __pyx_t_5numpy_uint8_t __pyx_v_byteskey); /* proto */
...
static __Pyx_memviewslice __pyx_f_3xor_xor(__Pyx_memviewslice __pyx_v_encode_model_, __pyx_t_5numpy_uint8_t __pyx_v_byteskey, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_empty_like); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_encode_model_, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_uint8_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_uint8_t, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 *     return tmp
 */
  __pyx_t_6 = (__pyx_v_encode_model_.shape[0]);
  __pyx_t_7 = __pyx_t_6;
 ...
 */
    ...
    *((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_tmp.data + __pyx_t_10 * __pyx_v_tmp.strides[0]) )) = ((*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_encode_model_.data + __pyx_t_9 * __pyx_v_encode_model_.strides[0]) ))) ^ __pyx_v_byteskey);
  }
...
static PyObject *__pyx_pw_3xor_1xor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_encode_model_ = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("xor (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_byteskey)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("xor", 1, 2, 2, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "xor") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_encode_model_ = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_encode_model_.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_byteskey = __Pyx_PyInt_As_npy_uint8(values[1]); if (unlikely((__pyx_v_byteskey == ((npy_uint8)-1)) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("xor", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("xor.xor", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_3xor_xor(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_encode_model_, __pyx_t_5numpy_uint8_t __pyx_v_byteskey) {
  ...
  if (unlikely(!__pyx_v_encode_model_.memview)) { __Pyx_RaiseUnboundLocalError("encode_model_"); __PYX_ERR(0, 9, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_3xor_xor(__pyx_v_encode_model_, __pyx_v_byteskey, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_uint8_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_uint8_t, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_encode_model_, 1);
